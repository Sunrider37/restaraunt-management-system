...
func GetOrderItemsByOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusNotFound, gin.H{"error": "error occured while listing order items by order"})
		}
		c.JSON(http.StatusOK, allOrderItems)
...
func GetOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusNotFound, gin.H{"error": "error occured while getting order item"})
			return
		}
...
func CreateOrderItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := c.BindJSON(&orderItemPack); err != nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": "error occured while binding order item pack"})
		}
		...
		for _, orderItem := range orderItemPack.Order_items {
			...
			if validationErr != nil {
				c.JSON(http.StatusBadRequest, gin.H{"error": "error occured while validating order item"})
			}
